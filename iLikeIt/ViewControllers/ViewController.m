...
- (void)viewDidLoad {
    ...
    _salesCountLabel.text = [NSString stringWithFormat:NSLocalizedString(@"Yesterday you sold %@ apps",@""), @(1000000)];
    [_likeButton setTitle:NSLocalizedString(@"You like?",@"") forState:UIControlStateNormal];
}
